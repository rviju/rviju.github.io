      ...
      <div className="">
        <div className="pt-6 pb-8 space-y-2 md:space-y-5">
          <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-5xl md:leading-14">
            Dearness Relief Calculator - Updated for Feb 2026
          </h1>
          {!showResult && !showForm && (
            <p className="text-lg leading-7 text-gray-500 dark:text-gray-400">
              Calculate your deareness relief with effect from Feb 2026, your gross pension, net
        ...
        <div className="">
          ...
          {showResult && formState.drCalculated && (
            <Result
              ...
              additionalExgratia={formState.additionalExgratia}
              locale="EN-IN"
            />
          )}
          {!showForm && (
